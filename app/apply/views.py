...
class ResumeAPI(APIView):
    ...
    @swagger_auto_schema(
        responses=get_resume_response, authentication_classes=[BasicAuthentication]
    )
    ...
    @swagger_auto_schema(
        request_body=ResumeRequestSerializer,
        authentication_classes=[BasicAuthentication],
    )
    ...
    @swagger_auto_schema(
        request_body=ResumeSerializer, authentication_classes=[BasicAuthentication]
    )
